...
Route::view('/driver-data', 'common.admin.driverdata.index');
Route::view('/driver-data/cities', 'common.admin.driverdata.cities');
Route::view('/driver-data/type-of-cars', 'common.admin.driverdata.type_of_cars');

Route::view('/reward', 'common.admin.reward.index');
Route::view('/news', 'common.admin.news.index');
...
Route::view('/driver-promotion', 'common.admin.driver_promotion.index');
Route::view('/driver-promotion/create', 'common.admin.driver_promotion.form');
Route::get('/driver-promotion/{id}/edit', function ($id) {
    return view('common.admin.driver_promotion.form', compact('id'));
});
...
Route::view('/cmsfaq', 'common.admin.cmspage.faq');
Route::view('/cmshowitworks', 'common.admin.cmspage.howitworks');
Route::view('/cmshomenews', 'common.admin.cmspage.homenews');
