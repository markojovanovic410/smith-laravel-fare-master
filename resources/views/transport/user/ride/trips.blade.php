         ...
         success:function(data){
            ...
            $.each(result,function(key,item){
               ...
               if(result.provider){
                  ...
                  if(result.rating !=null && result.rating.user_comment !== null)
                  {
               ...
               $('.wallet').text(result.payment.wallet);
               $('.promocode').text(result.payment.discount);
   ...
   trips_table = trips_table.DataTable( {
        ...
        "columns": [
         { "data": "id" ,render: function (data, type, row, meta) {
            ...
            { "data": "status" },
            { "data": "refund_status" ,render: function (data, type, row) {
               return row.payment_refund != null &&  row.payment_refund.refund_status ? row.payment_refund.refund_status.toUpperCase() : '';
               }
            },
