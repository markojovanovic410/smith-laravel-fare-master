               ...
               html += `<div class="col-lg-4 col-md-4 col-sm-4 card-section">
                     ...
                     <div class="card-img">
                        ...
                        <div class="card-number">
                           <span>XXXX</span> <span>XXXX</span><span>XXXX</span><span class ="last_four">`+item.last4+`</span><br>
                           <small>`+item.exp_month+`/`+item.exp_year+`</small><br>
                           <span class = "holder_name">`+item.card_type+`</span>
                        </div>
                     </div>
