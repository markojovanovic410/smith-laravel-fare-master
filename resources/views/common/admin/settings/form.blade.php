                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-xl-6">
                                <label for="tax_percentage" class=" col-form-label">Footer Contact Us Text</label>
                                <input class="form-control" type="text" value="{{ Helper::getSettings()->site->footer_contact_us_text  }}" name="footer_contact_us_text" id="footer_contact_us_text" placeholder="Footer Contact Us Text">
                            </div>
                        </div>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <input class="form-control number" type="text" value="{{ Helper::getSettings()->order->store_response_time  }}" name="store_response_time" required id="resturant_response_time" placeholder="@lang('admin.setting.resturant_response_time')">
                            </div>
                        </div>
...
function switchCard(){
	var isChecked = $("#paystack").is(":checked");
	if(isChecked){
        $("#paystack").val(1);
