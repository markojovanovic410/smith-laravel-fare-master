...
@section('title') {{ __('Promocodes') }} @stop
...
<div class="main-content-container container-fluid px-4">
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            <span class="text-uppercase page-subtitle">{{ __('Promocodes') }}</span>
            <h3 class="page-title">{{ __('Promocodes') }} {{ __('List') }}</h3>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    <h6 class="m-0 pull-left">{{ __('Promocodes') }}</h6>
                   
                    <a href="javascript:;" class="btn btn-success pull-right add"><i class="fa fa-plus"></i> {{ __('Add New') }} {{ __('Promocodes') }}</a>
                ...
                <thead>
                    <tr>
                        ...
                        <th data-value="user_type">User Type</th>
                        <th data-value="apply_type">Apply Type</th>
