...
<div class="nav-wrapper">
    <ul class="nav flex-column">
        ...
        @permission('promocodes-list')
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/admin/driver-promotion') }}">
                    <i class="material-icons">local_activity</i>
                    <span>{{ __('Driver Promotions') }}</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/admin/reward') }}">
                    <i class="material-icons">local_activity</i>
                    <span>{{ __('Reward') }}</span>
                </a>
            </li>
        ...
        @permission('cms-pages')
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#collapse-cms-pages" aria-expanded="true">
                    <i class="material-icons">pages</i>
                    <span class="menudrop_icon">{{ __('CMS Pages') }}</span>
                </a>
                <div id="collapse-cms-pages" class="collapse in" style="">
                    <a class="nav-link" href="{{ url('admin/cmspage')}}">
                        <i class="material-icons">pages</i>
                        <span>{{ __('CMS Pages') }}</span>
                    </a>
                    <a class="nav-link" href="{{ url('admin/cmsfaq')}}">
                        <i class="material-icons">pages</i>
                        <span>{{ __('FAQ Page') }}</span>
                    </a>
                    <a class="nav-link" href="{{ url('admin/cmshowitworks')}}">
                        <i class="material-icons">pages</i>
                        <span>{{ __('How It Works') }}</span>
                    </a>
                    <a class="nav-link" href="{{ url('admin/cmshomenews')}}">
                        <i class="material-icons">pages</i>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/admin/driver-data') }}">
                <i class="material-icons">person</i>
                <span>{{ __('Driver Data') }}</span>
            </a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="{{ url('/admin/driver-data/cities') }}">
                <i class="material-icons">person</i>
                <span>{{ __('Driver Data Cities') }}</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/admin/driver-data/type-of-cars') }}">
                <i class="material-icons">person</i>
                <span>{{ __('Driver Data Type of Cars') }}</span>
            </a>
        </li>
