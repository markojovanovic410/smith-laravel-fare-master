...
$(document).ready(function() {
    ...
    var keys = {full_name: "User Name", mobile: "Mobile", status: "Status", rides_count: "Total Rides", services_count: "Total Services", orders_count: "Total Orders", payment: "Total Spendings", created_at: "Joined at"};
