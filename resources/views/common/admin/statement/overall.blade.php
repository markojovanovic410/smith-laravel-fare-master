...
@section('title') {{ __('Overall Admin Statements') }} @stop
...
<div class="main-content-container container-fluid px-4">
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            <span class="text-uppercase page-subtitle">{{ __('Overall Admin Transactions') }}</span>
            <h3 class="page-title">{{ __('Overall Admin Transactions') }}</h3>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    <h6 class="m-0">{{ __('Overall Admin Transactions') }}</h6>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-12">         		
					<form class="form-horizontal" action="{{URL::to('admin/transactions')}}" method="GET" enctype="multipart/form-data" role="form">
...
$(document).ready(function() {
    ...
    var url = getBaseUrl() + "/admin/transactions";
    ...
    table = table.DataTable( {
        ...
        "ordering": true,
        "ajax": {
            "url": getBaseUrl() + "/admin/transactions?country_id="+countryVal+"&type="+typeVal+"&from="+FromDate+"&to="+ToDate,
            "type": "GET",
            'beforeSend': function (request) {
                showLoader();
            },
