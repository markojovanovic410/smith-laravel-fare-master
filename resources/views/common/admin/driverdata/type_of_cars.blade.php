...
<div class="main-content-container container-fluid px-4">
   <div class="row mb-4 mt-20">
      ...
      <div class="col-md-6">
         <div class="card card-small">
            <div class="card-header border-bottom">
               <h6 class="m-0">{{ __('Add/Edit Type of Car') }}</h6>
            </div>
            <div class="col-md-12">
               <form class="validateForm">
                  ...
                  <div class="form-row">
                     <div class="form-group col-md-12">
                        <label for="name" class="col-xs-2 col-form-label">Type of car</label>
      ...
      <div class="col-md-6">
         <div class="card card-small">
            <div class="card-header border-bottom">
               <h6 class="m-0">{{ __('Type of Cars List') }}</h6>
            </div>
...
$(document).ready(function() {
    ...
    $('.validateForm').validate({
        ...
        submitHandler: function(form) {
            ...
            var url = getBaseUrl() + "/admin/driver-data/type-of-cars";

            saveRow(url, null, data, 'admin', '/admin/driver-data/type-of-cars');
    ...
    $.ajax({
        type: "GET",
        url: getBaseUrl() + "/admin/driver-data/type-of-cars",
        headers: {
    ...
    $(document).on("click", "span.deletecmshowitworks" , function() {
        ...
        $.ajax({
            type: "delete",
            url: getBaseUrl() + `/admin/driver-data/type-of-cars/${id}`,
            headers: {
                Authorization: "Bearer " + getToken("admin")
            },
            success: function(data) {
