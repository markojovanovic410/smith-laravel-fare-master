...
@section('title') {{ __('Driver Promotions') }} @stop
...
<div class="main-content-container container-fluid px-4">
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            <span class="text-uppercase page-subtitle">{{ __('Driver Promotions') }}</span>
            <h3 class="page-title">{{ __('Driver Promotions') }} {{ __('List') }}</h3>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    <h6 class="m-0 pull-left">{{ __('Driver Promotions') }}</h6>
                   
                    <a href="javascript:;" class="btn btn-success pull-right add"><i class="fa fa-plus"></i> {{ __('Add New') }} {{ __('Driver Promotions') }}</a>
                ...
                <thead>
                    <tr>
                        ...
                        <th data-value="service">Service</th>
                        <th data-value="bonus">bonus</th>
                        <th data-value="no_of_rides">No of Rides</th>
                        <th data-value="description">Description</th>
                        <th data-value="start">Start Date</th>
                        <th data-value="end">End Date</th>
                        <th data-value="picture">Picture</th>
...
$(document).ready(function() {
    ...
    $('.add').on('click', function(e) {
        e.preventDefault();
        $.get("{{ url('admin/driver-promotion/create') }}", function(data) {
    ...
    $('body').on('click', '.edit', function(e) {
        e.preventDefault();
        $.get("{{ url('admin/driver-promotion/') }}/"+$(this).data('id')+"/edit", function(data) {
            $('.crud-modal .modal-container').html("");
            $('.crud-modal .modal-container').html(data);
        });
        $('.crud-modal').modal('show');
    ...
    table = table.DataTable( {
        ...
        "serverSide": true,
        "ajax": {
            "url": getBaseUrl() + "/admin/driver-promotion",
            "type": "GET",
