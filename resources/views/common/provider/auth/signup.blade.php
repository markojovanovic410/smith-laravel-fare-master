         ...
         <div id="sign-up" class="sign-in-section dis-center">
            <div class="h-100 col-sm-12 col-md-12 col-lg-12 dis-column ">
               ...
               <div class="account_kit" @if(Helper::getSettings()->site->send_sms == 1) style="display:none" @endif>
                 <input id="email" name="email" class="form-control mb-4" placeholder="@lang('auth.email_address')" type="email" aria-required="true" >
                 <div class="col-sm-12 col-md-12 col-lg-12 p-0 d-flex">
                    <div class="col-sm-6 p-0 mr-1">
                       <input id="first_name" name="first_name" class="form-control mb-4" value="" placeholder="@lang('auth.first_name')" type="text" >
                    </div>
                    <div class="col-sm-6 p-0">
                       <input id="last_name" name="last_name" class="form-control mb-4" value="" placeholder="@lang('auth.last_name')" type="text" >
                    </div>
                 </div>
                 ...
                 <input id="password_confirmation" name="password_confirmation" class="form-control mb-4" value="" placeholder="@lang('auth.confirm_password')" type="password" >
                 ...
                 <input id="referral_code" name="referral_code" class="form-control mb-4" placeholder="@lang('auth.referral_code')" type="text" >
               </div>
               @if(Helper::getSettings()->site->send_sms == 1)
      ...
      <div id="social-login" class="col-sm-12 col-md-12 col-lg-12 d-none">
         <div class="sign-in-section dis-center">
            <div class="h-100 col-sm-12 col-md-5 col-lg-5 dis-column content-card">
               ...
               <input id="mobile" name="mobile" maxlength="15" class="intl-tel phone form-control mb-4 d-none" placeholder="@lang('auth.phone_number')" type="text" >
               <input id="email" name="email" class="form-control mb-4 d-none" placeholder="@lang('auth.email_address')" type="email" aria-required="true" >
               <select name="gender" id="gender" class="w-100 mb-3">
                  <option value="">@lang('auth.select_gender')</option>
                  <option value="MALE">@lang('auth.MALE')</option>
                  <option value="FEMALE">@lang('auth.FEMALE')</option>
