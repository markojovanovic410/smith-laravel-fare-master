        ...
        success: (data, textStatus, jqXHR) => {
            if((data.responseData).length != 0) { 
                      ...
                      mycat+=item.store_category_name+',';
                        ...
                        if(store_data.storetype.category=='FOOD'){
                           ...
                           profile_desc +='<li class="nav-item ratings">\
                            ...
                            <li class="nav-item">\
                              <a href="{{url("user/store/list/")}}/'+store_data.store_type_id + '?city_id='+userSettings.city_id  +'" class="btn  btn-small btn-green2"> << Back</a>\
                           </li>\
                           <li class="nav-item">\
                ...
                $.each(store_data.products,function(key,item){ 
                  ...
                  window.location.href= "{{url('user/store/list/'.$id)}}" + "?city_id="+userSettings.city_id;
            }
            hideLoader();
        }
         });
