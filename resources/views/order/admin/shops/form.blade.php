...
<div class="row mb-4 mt-20">
    <div class="col-md-12">
        ...
        <form class="validateForm" files="true"> 
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="password">@lang('store.admin.shops.confirmpassword')</label>
                        <input type="password" class="form-control" id="confirmpassword"  placeholder="{{ __('store.admin.shops.confirmpassword') }}" >
                    </div>
                    <div class="form-group col-md-6">
