            ...
            <form class="validateForm" files="true">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="email" name="email" placeholder="{{ __('store.admin.shops.email') }}" value="">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="offer_min_amount">{{ __('store.admin.shops.minamount') }}</label>
                            <input type="text" class="form-control decimal" id="offer_min_amount" name="offer_min_amount" placeholder="{{ __('store.admin.shops.minamount') }}" >
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control decimal" id="offer_percent" name="offer_percent" placeholder="{{ __('store.admin.shops.offper') }}" >
                        </div>
                    </div> 
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6" id="estdeltime">
                            ...
                            <input type="number" class="form-control" id="estimated_delivery_time" name="estimated_delivery_time" placeholder="{{ __('store.admin.shops.estdeltime') }}" >
                        </div>
                    </div> 
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="store_gst">{{ __('store.admin.shops.gst') }}</label>
                            <input type="number" class="form-control" id="store_gst" name="store_gst" placeholder="{{ __('store.admin.shops.gst') }}" value="0" >
        
                        </div>
                        <div class="form-group col-md-6">
                            <label for="commission">{{ __('store.admin.shops.commission') }}</label>
                            <input type="number" class="form-control decimal" id="commission" name="commission" placeholder="{{ __('store.admin.shops.commission') }}" value="0" >
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <textarea class="form-control" placeholder="Enter Description"  maxlength="255"  id="description" name="description"></textarea>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="store_zipcode" name="store_zipcode" placeholder="{{ __('store.admin.shops.pincode') }}" >
                        </div>
                    </div>  
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <div class="form-group" id="mail_request">
                                ...
                                <div class="custom-control custom-toggle">
                                    <input type="checkbox" id="ffree_delivery" name="free_delivery" class="custom-control-input" value ='1'>
