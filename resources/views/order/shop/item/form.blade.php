        ...
        <form class="validateForm" files="true"> 
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="form-control" placeholder="{{ __('store.admin.item.description') }}" id="item_description" maxlength="255" name="item_description"></textarea>
             ...
             <div class="form-row">
                 <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        <label for="addon_list">@lang('store.admin.item.addon_list')</label>
